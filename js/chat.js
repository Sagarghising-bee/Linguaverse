/* ═══════════════════════════════
   chat.js — LinguaVerse
   API calls via PythonAnywhere Flask proxy — key never exposed
═══════════════════════════════ */
...
// ── PROXY URL — all Gemini calls go through PythonAnywhere Flask ──
const PROXY_URL = '/api/gemini'; // PythonAnywhere Flask proxy
...
// ── GEMINI API — via PythonAnywhere proxy, key hidden server-side ──
